...
class DOGEventCfg:
    ...
    reset_robot_joints = EventTerm(
        func=DOG_mdp.reset_joints_around_default,
        mode="reset",
        params={
...
class DOGRewardsCfg:
    ...
    base_angular_velocity = RewardTermCfg(
        func=DOG_mdp.base_angular_velocity_reward,
        weight=5.0,
        params={"std": 2.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    base_linear_velocity = RewardTermCfg(
        func=DOG_mdp.base_linear_velocity_reward,
        weight=5.0,
        params={"std": 1.0, "ramp_rate": 0.5, "ramp_at_vel": 1.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    foot_clearance = RewardTermCfg(
        func=DOG_mdp.foot_clearance_reward,
        weight=0.5,
        params={
            "std": 0.05,
            "tanh_mult": 2.0,
    ...
    # -- penalties
    action_smoothness = RewardTermCfg(func=DOG_mdp.action_smoothness_penalty, weight=-1.0)
    air_time_variance = RewardTermCfg(
        func=DOG_mdp.air_time_variance_penalty,
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_FOOT_LINK")},
    )
    base_motion = RewardTermCfg(
        func=DOG_mdp.base_motion_penalty, weight=-2.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    base_orientation = RewardTermCfg(
        func=DOG_mdp.base_orientation_penalty, weight=-3.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    foot_slip = RewardTermCfg(
        func=DOG_mdp.foot_slip_penalty,
        weight=-0.5,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_FOOT_LINK"),
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_FOOT_LINK"),
    ...
    joint_acc = RewardTermCfg(
        func=DOG_mdp.joint_acceleration_penalty,
        weight=-1.0e-4,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*_JOINT")},
    )
    joint_pos = RewardTermCfg(
        func=DOG_mdp.joint_position_penalty,
        weight=-0.7,
        params={
    ...
    joint_torques = RewardTermCfg(
        func=DOG_mdp.joint_torques_penalty,
        weight=-5.0e-4,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*")},
    )
    joint_vel = RewardTermCfg(
        func=DOG_mdp.joint_velocity_penalty,
        weight=-1.0e-2,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*_JOINT")},
    )
...
@configclass
class DOGTerminationsCfg:
    """Termination terms for the MDP."""

    time_out = DoneTerm(func=mdp.time_out, time_out=True)
    body_contact = DoneTerm(
        func=mdp.illegal_contact,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["BASE_LINK", ".*_HIP_LINK"]), "threshold": 1.0},
    )
...
@configclass
class DOGFlatEnvCfg(LocomotionVelocityRoughEnvCfg):

    # Basic settings'
    observations: DOGObservationsCfg = DOGObservationsCfg()
    actions: DOGActionsCfg = DOGActionsCfg()
    commands: DOGCommandsCfg = DOGCommandsCfg()

    # MDP setting
    rewards: DOGRewardsCfg = DOGRewardsCfg()
    terminations: DOGTerminationsCfg = DOGTerminationsCfg()
    events: DOGEventCfg = DOGEventCfg()
...
class DOGFlatEnvCfg_PLAY(DOGFlatEnvCfg):
